...
/**
 * Interface defining coffee operations.
 */
interface CoffeeOperations {
    void brew();
    String describe();
}
...
public final class CoffeeCRUD { // Menggunakan keyword final untuk class
    ...
    private static int coffeeCount = 0; // Static variable to count Coffee objects
    ...
    private static final void addCoffee() { // Menggunakan keyword final untuk method
        ...
        coffeeCount++; // Increment static coffee count
        System.out.println("Coffee added successfully! Total coffees: " + coffeeCount);
    }
    ...
    private static void viewCoffees() {
        ...
        for (int i = 0; i < coffeeList.size(); i++) {
            System.out.println((i + 1) + ". " + coffeeList.get(i).describe());
        }
    }
    ...
    private static void updateCoffee() {
        ...
        System.out.println("Updating: " + coffee.describe());
    ...
    private static void deleteCoffee() {
        ...
        coffeeCount--; // Decrement static coffee count
        System.out.println("Coffee deleted successfully! Total coffees: " + coffeeCount);
    }
}

// Subclass Espresso
class Espresso extends Coffee implements CoffeeOperations {
...
// Subclass Latte
class Latte extends Coffee implements CoffeeOperations {
...
abstract class Coffee implements CoffeeOperations {
